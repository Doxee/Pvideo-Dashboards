 ...
 from 
    (
        ...
        from SHIPMENT sh
            ...
            join (
              select doxee_platform_id, shipment_id, end_date from EMAIL_TRANSFER where client_name = ? and procedure_name= ?
               union all
              select doxee_platform_id, shipment_id, end_date from PURL_TRANSFER where client_name = ? and procedure_name= ?
