...
/**
 * A simple mock implementation of the {@code Context} interface. Default values are stubbed out, and setters are provided so you can customize the context before passing it to your function.
 */
